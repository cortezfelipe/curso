...
class CidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $estado_id = new TDBUniqueSearch('estado_id', 'curso', 'Estado', 'id', 'nome');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['CidadeForm', 'onEdit']), 'fa:plus green');
        ...
        // add the columns to the DataGridrl
        $this->datagrid->addColumn($column_id);
        $this->datagrid->addColumn($column_nome);
        $this->datagrid->addColumn($column_estado_id);

        
        $action1 = new TDataGridAction(['CidadeForm', 'onEdit'], ['id'=>'{id}','nome'=> '{nome}']);
